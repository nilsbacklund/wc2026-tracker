import type { Bracket, Importance, Match, Snapshot, StandingRow, TeamProbs, WinningPaths } from "./types";
...
export const fetchWinningPaths = () => get<WinningPaths>("/winning-paths");
